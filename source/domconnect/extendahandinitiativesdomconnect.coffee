extendahandinitiativesdomconnect = {name: "extendahandinitiativesdomconnect"}

############################################################
extendahandinitiativesdomconnect.initialize = () ->
...
module.exports = extendahandinitiativesdomconnect