extendahandinitiativedomconnect = {name: "extendahandinitiativedomconnect"}

############################################################
extendahandinitiativedomconnect.initialize = () ->
...
module.exports = extendahandinitiativedomconnect