skyscraperinitiativedomconnect = {name: "skyscraperinitiativedomconnect"}

############################################################
skyscraperinitiativedomconnect.initialize = () ->
...
module.exports = skyscraperinitiativedomconnect