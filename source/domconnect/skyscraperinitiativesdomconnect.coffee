skyscraperinitiativesdomconnect = {name: "skyscraperinitiativesdomconnect"}

############################################################
skyscraperinitiativesdomconnect.initialize = () ->
...
module.exports = skyscraperinitiativesdomconnect